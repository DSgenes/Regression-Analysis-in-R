...
#Interaction between a categorical and quantitative explainer.
library(tidyverse)
library(modeldata)
library(ggplot2)
...
#take out the daily penguins so that i've only got two species of penguins 
...
#linear relationship between these two quantitative variables within each of these two groups
